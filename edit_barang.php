	...
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				?>
				<form class="form-input" method="post" enctype="multipart/form-data" action="handler.php?action=edit_barang" style="padding-top: 30px;"> <input type="hidden" name="id_barang" value="<?= $f['id_barang'] ?>">
					...
					<label for="">Foto (Kosongkan Jika Tidak Ingin Merubah)</label>
					<input type="file" name="foto" id="">
					<input type="hidden" name="foto_lama" id="" value=<?= $f['foto_produk'] ?>>
					<div class="padding">
						<?php if (!empty($f['foto_produk'])) { ?>
							<img src="images/produk/<?= $f['foto_produk'] ?>" alt="">
						<?php } ?>
					</div>
