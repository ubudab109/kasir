			...
			<div class="padding">
				...
				<table class="datatable" style="width: 100%;">
					...
					<tbody>
						...
						$data = $root->con->query("select barang.id_barang, barang.nama_barang,barang.harga_jual,sub_transaksi.jumlah_beli,sub_transaksi.total_harga from sub_transaksi inner join barang on barang.id_barang=sub_transaksi.id_barang where sub_transaksi.id_transaksi='$_GET[id_transaksi]'");
