					...
					<tbody>
						<form class="form-inline" id="subt" method="post" style="padding-top: 30px;">
							...
							<tr class="no-border">
									...
									<div class="input-group">
										<select style="width: 372px;cursor: pointer;" required="required" class="chosen" id="id_barang" name="id_barang">
											...
											while ($f = $data->fetch_assoc()) {
												echo "<option value='$f[id_barang]' data-img='images/produk/$f[foto_produk]'>$f[nama_barang]</option>";
											}
											?>
										</select>
								...
								<td>
									<input type="text" class="form-control" id="stock" readonly disabled>
								</td>
								<td>
									<input type="text" class="form-control" id="harga_jual" readonly disabled>
...
<script>
	...
	$(document).ready(function() {
		$('#id_barang').change((e) => {
			...
			var idBarang = $(this).find(":selected").val();
