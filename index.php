...
<html>
<head>
	<title>Login | Kasir Traditional Food</title>
	<style type="text/css">
	@font-face{
	...
	100%{opacity: 1;}
		...
		.both{clear: both;}
		.loginpage{position: fixed;background:url("assets/img/logo.jpg");height: 100%;width: 100%;background-size: 50%;}
			.padding{padding:80px 25px;}
			.login{float: right;width: 800px;background:#fff;height: 100%;}
...
<body>
	<div class="loginpage">
		...
		<div class="padding">
			<h3>Login Aplikasi Traditional Food</h3>
		<form id="loginapp">
